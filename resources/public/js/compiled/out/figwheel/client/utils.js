...
return (new CustomEvent(event_name,(function (){var obj54376 = {"detail":data};
return obj54376;
})()));
} else {
...
var args54381 = [];
var len__27054__auto___54387 = arguments.length;
var i__27055__auto___54388 = (0);
while(true){
if((i__27055__auto___54388 < len__27054__auto___54387)){
args54381.push((arguments[i__27055__auto___54388]));

var G__54389 = (i__27055__auto___54388 + (1));
i__27055__auto___54388 = G__54389;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args54381.length)].join('')));
...
var f = (function (){var pred__54384 = cljs.core._EQ_;
var expr__54385 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__54384.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__54385))){
return ((function (pred__54384,expr__54385){
return (function (p1__54377_SHARP_){
return console.warn(p1__54377_SHARP_);
});
;})(pred__54384,expr__54385))
} else {
if(cljs.core.truth_(pred__54384.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__54385))){
return ((function (pred__54384,expr__54385){
return (function (p1__54378_SHARP_){
return console.debug(p1__54378_SHARP_);
});
;})(pred__54384,expr__54385))
} else {
if(cljs.core.truth_(pred__54384.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__54385))){
return ((function (pred__54384,expr__54385){
return (function (p1__54379_SHARP_){
return console.error(p1__54379_SHARP_);
});
;})(pred__54384,expr__54385))
} else {
return ((function (pred__54384,expr__54385){
return (function (p1__54380_SHARP_){
return console.log(p1__54380_SHARP_);
});
;})(pred__54384,expr__54385))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__54391){
var map__54394 = p__54391;
var map__54394__$1 = ((((!((map__54394 == null)))?((((map__54394.cljs$lang$protocol_mask$partition0$ & (64))) || (map__54394.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__54394):map__54394);
var opts = map__54394__$1;
var eval_fn = cljs.core.get.call(null,map__54394__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__54396_SHARP_);
});})(new_def))
);
...
return (function (p__54397){
var vec__54398 = p__54397;
var ky = cljs.core.nth.call(null,vec__54398,(0),null);
var v = cljs.core.nth.call(null,vec__54398,(1),null);
...
var args54401 = [];
var len__27054__auto___54404 = arguments.length;
var i__27055__auto___54405 = (0);
while(true){
if((i__27055__auto___54405 < len__27054__auto___54404)){
args54401.push((arguments[i__27055__auto___54405]));

var G__54406 = (i__27055__auto___54405 + (1));
i__27055__auto___54405 = G__54406;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args54401.length)].join('')));
...
//# sourceMappingURL=utils.js.map?rel=1500065481311