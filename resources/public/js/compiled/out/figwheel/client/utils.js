...
var or__28569__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj86400 = {"detail":data};
return obj86400;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__28557__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__28557__auto__)){
var and__28557__auto____$1 = (window["CustomEvent"]);
...
var f = (function (){var pred__86407 = cljs.core._EQ_;
var expr__86408 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__86407.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__86408))){
return ((function (pred__86407,expr__86408){
return (function (p1__86401_SHARP_){
return console.warn(p1__86401_SHARP_);
});
;})(pred__86407,expr__86408))
} else {
if(cljs.core.truth_(pred__86407.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__86408))){
return ((function (pred__86407,expr__86408){
return (function (p1__86402_SHARP_){
return console.debug(p1__86402_SHARP_);
});
;})(pred__86407,expr__86408))
} else {
if(cljs.core.truth_(pred__86407.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__86408))){
return ((function (pred__86407,expr__86408){
return (function (p1__86403_SHARP_){
return console.error(p1__86403_SHARP_);
});
;})(pred__86407,expr__86408))
} else {
return ((function (pred__86407,expr__86408){
return (function (p1__86404_SHARP_){
return console.log(p1__86404_SHARP_);
});
;})(pred__86407,expr__86408))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__86411){
var map__86412 = p__86411;
var map__86412__$1 = ((((!((map__86412 == null)))?((((map__86412.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__86412.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__86412):map__86412);
var opts = map__86412__$1;
var eval_fn = cljs.core.get.call(null,map__86412__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__86414_SHARP_){
return new_def.callback(p1__86414_SHARP_);
});})(new_def))
);
...
return (function (p__86415){
var vec__86416 = p__86415;
var ky = cljs.core.nth.call(null,vec__86416,(0),null);
var v = cljs.core.nth.call(null,vec__86416,(1),null);
...
if(cljs.core.truth_((function (){var and__28557__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1500526513146