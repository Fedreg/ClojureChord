...
return (new CustomEvent(event_name,(function (){var obj33386 = {"detail":data};
return obj33386;
})()));
} else {
...
var args33391 = [];
var len__27054__auto___33397 = arguments.length;
var i__27055__auto___33398 = (0);
while(true){
if((i__27055__auto___33398 < len__27054__auto___33397)){
args33391.push((arguments[i__27055__auto___33398]));

var G__33399 = (i__27055__auto___33398 + (1));
i__27055__auto___33398 = G__33399;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args33391.length)].join('')));
...
var f = (function (){var pred__33394 = cljs.core._EQ_;
var expr__33395 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__33394.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__33395))){
return ((function (pred__33394,expr__33395){
return (function (p1__33387_SHARP_){
return console.warn(p1__33387_SHARP_);
});
;})(pred__33394,expr__33395))
} else {
if(cljs.core.truth_(pred__33394.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__33395))){
return ((function (pred__33394,expr__33395){
return (function (p1__33388_SHARP_){
return console.debug(p1__33388_SHARP_);
});
;})(pred__33394,expr__33395))
} else {
if(cljs.core.truth_(pred__33394.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__33395))){
return ((function (pred__33394,expr__33395){
return (function (p1__33389_SHARP_){
return console.error(p1__33389_SHARP_);
});
;})(pred__33394,expr__33395))
} else {
return ((function (pred__33394,expr__33395){
return (function (p1__33390_SHARP_){
return console.log(p1__33390_SHARP_);
});
;})(pred__33394,expr__33395))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__33401){
...
var eval_fn = cljs.core.get.call(null,map__33404__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__33406_SHARP_);
});})(new_def))
);
...
return (function (p__33407){
var vec__33408 = p__33407;
var ky = cljs.core.nth.call(null,vec__33408,(0),null);
var v = cljs.core.nth.call(null,vec__33408,(1),null);
...
var args33411 = [];
var len__27054__auto___33414 = arguments.length;
var i__27055__auto___33415 = (0);
while(true){
if((i__27055__auto___33415 < len__27054__auto___33414)){
args33411.push((arguments[i__27055__auto___33415]));

var G__33416 = (i__27055__auto___33415 + (1));
i__27055__auto___33415 = G__33416;
continue;
} else {
}
break;
...
//# sourceMappingURL=utils.js.map?rel=1499270873183