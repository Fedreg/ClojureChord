...
return cljs.core.reduce.call(null,(function (result,p__45064){
...
var vec__45071 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__45071,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__45071,(1),null);
var ab = cljs.core.nth.call(null,vec__45071,(2),null);
...
var args45074 = [];
var len__27054__auto___45077 = arguments.length;
var i__27055__auto___45078 = (0);
while(true){
if((i__27055__auto___45078 < len__27054__auto___45077)){
args45074.push((arguments[i__27055__auto___45078]));

var G__45079 = (i__27055__auto___45078 + (1));
i__27055__auto___45078 = G__45079;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args45074.length)].join('')));
...
return (function (){var G__45084 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__45084) {
case "atom":
...
//# sourceMappingURL=data.js.map?rel=1499706550967