...
var o__35589__auto___36624 = (function (){var o__35589__auto__ = (function (){var o__35589__auto__ = Promise;
return goog.object.get(o__35589__auto__,"resolve").call(o__35589__auto__);
})();
return goog.object.get(o__35589__auto__,"then").call(o__35589__auto__,callback);
})();
goog.object.get(o__35589__auto___36624,"catch").call(o__35589__auto___36624,devtools.async.rethrow_outside_promise);
...
var G__36626_36627 = Error;
var target__35608__auto___36628 = G__36626_36627;
if(cljs.core.truth_(target__35608__auto___36628)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__36626_36627)].join('')),cljs.core.str("\n"),cljs.core.str("target__35608__auto__")].join('')));
}

goog.object.set(target__35608__auto___36628,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1499366869011