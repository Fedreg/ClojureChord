...
var o__37079__auto___40487 = (function (){var o__37079__auto__ = (function (){var o__37079__auto__ = Promise;
return goog.object.get(o__37079__auto__,"resolve").call(o__37079__auto__);
})();
return goog.object.get(o__37079__auto__,"then").call(o__37079__auto__,callback);
})();
goog.object.get(o__37079__auto___40487,"catch").call(o__37079__auto___40487,devtools.async.rethrow_outside_promise);
...
var G__40489_40490 = Error;
var target__37098__auto___40491 = G__40489_40490;
if(cljs.core.truth_(target__37098__auto___40491)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__40489_40490)].join('')),cljs.core.str("\n"),cljs.core.str("target__37098__auto__")].join('')));
}

goog.object.set(target__37098__auto___40491,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1499270890169