...
var G__73765 = devtools.prefs.pref.call(null,v);
v = G__73765;
continue;
} else {
return v;
...
}catch (e73778){var e__42727__auto__ = e73778;
return false;
}})();
...
}catch (e73782){var e__42727__auto__ = e73782;
return false;
}})();
...
}catch (e73784){var e__42727__auto__ = e73784;
return false;
}}
}
});
...
var vec__73789 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__73789,(0),null);
var name = cljs.core.nth.call(null,vec__73789,(1),null);
...
return cljs.core.some.call(null,(function (p1__73792_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__73792_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1499924887620