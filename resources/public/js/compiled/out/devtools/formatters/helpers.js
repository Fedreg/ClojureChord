...
var G__39672 = devtools.prefs.pref.call(null,v);
v = G__39672;
continue;
} else {
return v;
...
}catch (e39675){var e__37626__auto__ = e39675;
return false;
}})();
...
}catch (e39679){var e__37626__auto__ = e39679;
return false;
}})();
...
}catch (e39681){var e__37626__auto__ = e39681;
return false;
}}
}
});
...
var vec__39683 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39683,(0),null);
var name = cljs.core.nth.call(null,vec__39683,(1),null);
...
return cljs.core.some.call(null,(function (p1__39686_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39686_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1500435986758