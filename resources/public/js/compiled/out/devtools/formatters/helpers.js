...
var G__39701 = devtools.prefs.pref.call(null,v);
v = G__39701;
continue;
} else {
return v;
...
}catch (e39714){var e__37104__auto__ = e39714;
return false;
}})();
...
}catch (e39718){var e__37104__auto__ = e39718;
return false;
}})();
...
}catch (e39720){var e__37104__auto__ = e39720;
return false;
}}
}
});
...
var vec__39725 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39725,(0),null);
var name = cljs.core.nth.call(null,vec__39725,(1),null);
...
return cljs.core.some.call(null,(function (p1__39728_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39728_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1499270887804