...
var G__92186 = devtools.prefs.pref.call(null,v);
v = G__92186;
continue;
} else {
return v;
...
var and__28557__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__28557__auto__){
var and__28557__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__28569__auto__ = (function (){try{if(!((value == null))){
...
}catch (e92189){var e__38348__auto__ = e92189;
return false;
}})();
if(cljs.core.truth_(or__28569__auto__)){
return or__28569__auto__;
} else {
var or__28569__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e92193){var e__38348__auto__ = e92193;
return false;
}})();
...
}catch (e92195){var e__38348__auto__ = e92195;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__28557__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__28557__auto__)){
var and__28557__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__28557__auto____$1){
...
var and__28557__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__28557__auto__)){
...
var or__28569__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__28569__auto__)){
return or__28569__auto__;
} else {
...
var and__28557__auto__ = (function (){var or__28569__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__28569__auto__)){
return or__28569__auto__;
} else {
...
var vec__92197 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__92197,(0),null);
var name = cljs.core.nth.call(null,vec__92197,(1),null);
...
var and__28557__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__28557__auto__)){
...
var or__28569__auto__ = typeof value === 'string';
if(or__28569__auto__){
return or__28569__auto__;
} else {
var or__28569__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__92200_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__92200_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1500526713010