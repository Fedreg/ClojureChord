...
var G__45322 = devtools.prefs.pref.call(null,v);
v = G__45322;
continue;
} else {
return v;
...
}catch (e45335){var e__42727__auto__ = e45335;
return false;
}})();
...
}catch (e45339){var e__42727__auto__ = e45339;
return false;
}})();
...
}catch (e45341){var e__42727__auto__ = e45341;
return false;
}}
}
});
...
var vec__45346 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__45346,(0),null);
var name = cljs.core.nth.call(null,vec__45346,(1),null);
...
return cljs.core.some.call(null,(function (p1__45349_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__45349_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1499706554281