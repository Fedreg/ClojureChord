...
var G__61987 = devtools.prefs.pref.call(null,v);
v = G__61987;
continue;
} else {
return v;
...
}catch (e62000){var e__37744__auto__ = e62000;
return false;
}})();
...
}catch (e62004){var e__37744__auto__ = e62004;
return false;
}})();
...
}catch (e62006){var e__37744__auto__ = e62006;
return false;
}}
}
});
...
var vec__62011 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__62011,(0),null);
var name = cljs.core.nth.call(null,vec__62011,(1),null);
...
return cljs.core.some.call(null,(function (p1__62014_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__62014_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1499548780876