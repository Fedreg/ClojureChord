...
var len__27054__auto___45365 = arguments.length;
var i__27055__auto___45366 = (0);
while(true){
if((i__27055__auto___45366 < len__27054__auto___45365)){
args__27061__auto__.push((arguments[i__27055__auto___45366]));

var G__45367 = (i__27055__auto___45366 + (1));
i__27055__auto___45366 = G__45367;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq45362){
var G__45363 = cljs.core.first.call(null,seq45362);
var seq45362__$1 = cljs.core.next.call(null,seq45362);
var G__45364 = cljs.core.first.call(null,seq45362__$1);
var seq45362__$2 = cljs.core.next.call(null,seq45362__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__45363,G__45364,seq45362__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__45368_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__45368_SHARP_));
})))){
...
var map__45377 = opts;
var map__45377__$1 = ((((!((map__45377 == null)))?((((map__45377.cljs$lang$protocol_mask$partition0$ & (64))) || (map__45377.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45377):map__45377);
var markup_db = cljs.core.get.call(null,map__45377__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e45381){var e__42727__auto__ = e45381;
return false;
}})();
if(cljs.core.truth_(or__25979__auto__)){
return or__25979__auto__;
...
}catch (e45383){var e__42727__auto__ = e45383;
return false;
}}
})())){
...
var _STAR_current_state_STAR_45388 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__45389 = opts;
var map__45389__$1 = ((((!((map__45389 == null)))?((((map__45389.cljs$lang$protocol_mask$partition0$ & (64))) || (map__45389.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45389):map__45389);
var markup_db = cljs.core.get.call(null,map__45389__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_45388;
}});
...
;
var temp__4655__auto___45394 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___45394)){
var managed_print_level_45395 = temp__4655__auto___45394;
var _STAR_print_level_STAR_45393_45396 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_45395;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_45393_45396,managed_print_level_45395,temp__4655__auto___45394,writer,opts,job_fn){
return (function (p1__45391_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__45391_SHARP_,null);
});})(_STAR_print_level_STAR_45393_45396,managed_print_level_45395,temp__4655__auto___45394,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_45393_45396;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1499706555028