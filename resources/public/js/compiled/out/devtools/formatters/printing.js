...
var len__27054__auto___62030 = arguments.length;
var i__27055__auto___62031 = (0);
while(true){
if((i__27055__auto___62031 < len__27054__auto___62030)){
args__27061__auto__.push((arguments[i__27055__auto___62031]));

var G__62032 = (i__27055__auto___62031 + (1));
i__27055__auto___62031 = G__62032;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq62027){
var G__62028 = cljs.core.first.call(null,seq62027);
var seq62027__$1 = cljs.core.next.call(null,seq62027);
var G__62029 = cljs.core.first.call(null,seq62027__$1);
var seq62027__$2 = cljs.core.next.call(null,seq62027__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__62028,G__62029,seq62027__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__62033_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__62033_SHARP_));
})))){
...
var map__62042 = opts;
var map__62042__$1 = ((((!((map__62042 == null)))?((((map__62042.cljs$lang$protocol_mask$partition0$ & (64))) || (map__62042.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__62042):map__62042);
var markup_db = cljs.core.get.call(null,map__62042__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e62046){var e__37744__auto__ = e62046;
return false;
}})();
if(cljs.core.truth_(or__25979__auto__)){
return or__25979__auto__;
...
}catch (e62048){var e__37744__auto__ = e62048;
return false;
}}
})())){
...
var _STAR_current_state_STAR_62053 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__62054 = opts;
var map__62054__$1 = ((((!((map__62054 == null)))?((((map__62054.cljs$lang$protocol_mask$partition0$ & (64))) || (map__62054.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__62054):map__62054);
var markup_db = cljs.core.get.call(null,map__62054__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_62053;
}});
...
;
var temp__4655__auto___62059 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___62059)){
var managed_print_level_62060 = temp__4655__auto___62059;
var _STAR_print_level_STAR_62058_62061 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_62060;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_62058_62061,managed_print_level_62060,temp__4655__auto___62059,writer,opts,job_fn){
return (function (p1__62056_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__62056_SHARP_,null);
});})(_STAR_print_level_STAR_62058_62061,managed_print_level_62060,temp__4655__auto___62059,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_62058_62061;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1499548781170