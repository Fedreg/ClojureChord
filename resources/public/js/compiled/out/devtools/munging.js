...
var temp__5276__auto__ = (function (){var temp__5278__auto__ = goog.object.get(devtools.munging.get_global_scope.call(null),"cljs");
if(cljs.core.truth_(temp__5278__auto__)){
var o__38336__auto__ = temp__5278__auto__;
var temp__5278__auto____$1 = goog.object.get(o__38336__auto__,"core");
if(cljs.core.truth_(temp__5278__auto____$1)){
var o__38335__auto__ = temp__5278__auto____$1;
return goog.object.get(o__38335__auto__,"js_reserved_QMARK_");
} else {
return null;
}
} else {
...
try{var o__38323__auto__ = f;
return goog.object.get(o__38323__auto__,"toString").call(o__38323__auto__);
}catch (e92088){var _ = e92088;
return "";
}});
...
try{var o__38323__auto___92090 = t;
goog.object.get(o__38323__auto___92090,"cljs$lang$ctorPrWriter").call(o__38323__auto___92090,t,writer);
}catch (e92089){var __92091 = e92089;
}
...
var char_code = (function (){var o__38323__auto__ = (new String(char$));
return goog.object.get(o__38323__auto__,"charCodeAt").call(o__38323__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38323__auto__ = String;
return goog.object.get(o__38323__auto__,"fromCharCode").call(o__38323__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__92092 = num_code;
switch (G__92092) {
case (1):
return (185);
...
var o__38323__auto__ = String;
return goog.object.get(o__38323__auto__,"fromCharCode").call(o__38323__auto__,superscript_code);
});
/**
...
}catch (e92094){var e__38348__auto__ = e92094;
return false;
}})())){
...
var vec__92095 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__92095,(0),null);
...
var or__28569__auto__ = (function (){var temp__5276__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5276__auto__)){
...
var temp__5276__auto__ = (function (){var temp__5278__auto__ = goog.object.get(devtools.munging.get_global_scope.call(null),"goog");
if(cljs.core.truth_(temp__5278__auto__)){
var o__38336__auto__ = temp__5278__auto__;
var temp__5278__auto____$1 = goog.object.get(o__38336__auto__,"dependencies_");
if(cljs.core.truth_(temp__5278__auto____$1)){
var o__38335__auto__ = temp__5278__auto____$1;
return goog.object.get(o__38335__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__29802__auto___92104 = arguments.length;
var i__29803__auto___92105 = (0);
while(true){
if((i__29803__auto___92105 < len__29802__auto___92104)){
args__29809__auto__.push((arguments[i__29803__auto___92105]));

var G__92106 = (i__29803__auto___92105 + (1));
i__29803__auto___92105 = G__92106;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29810__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__92100){
var vec__92101 = p__92100;
var ns_detector = cljs.core.nth.call(null,vec__92101,(0),null);
var effective_detector = (function (){var or__28569__auto__ = ns_detector;
if(cljs.core.truth_(or__28569__auto__)){
return or__28569__auto__;
} else {
...
var G__92107 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__92108 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__92107;
remaining_tokens = G__92108;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq92098){
var G__92099 = cljs.core.first.call(null,seq92098);
var seq92098__$1 = cljs.core.next.call(null,seq92098);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__92099,seq92098__$1);
});
...
var vec__92112 = cljs.core.split_with.call(null,(function (p1__92111_SHARP_){
return cljs.core.not_EQ_.call(null,p1__92111_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__92112,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__92112,(1),null);
...
var vec__92115 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__92115,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__92115,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__92118 = cljs.core.rest.call(null,remaining_tokens);
var G__92119 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__92118;
name_tokens = G__92119;
continue;
} else {
...
var vec__92122 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__92122,(0),null);
var arity = cljs.core.nth.call(null,vec__92122,(1),null);
var vec__92125 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__92125,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__92125,(1),null);
var vec__92128 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__92128,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__92128,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__92128,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__92128,(3),null);
...
var vec__92134 = result;
var munged_ns = cljs.core.nth.call(null,vec__92134,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__92134,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__92134,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__92134,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__92134,(4),null);
var arity = cljs.core.nth.call(null,vec__92134,(5),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var vec__92138 = temp__5276__auto__;
var munged_name = cljs.core.nth.call(null,vec__92138,(0),null);
var args = cljs.core.nth.call(null,vec__92138,(1),null);
var vec__92141 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__92141,(0),null);
var name = cljs.core.nth.call(null,vec__92141,(1),null);
...
var G__92144 = (arity + (1));
var G__92145 = (function (){var temp__5276__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5276__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__92146){
var vec__92147 = p__92146;
var arity = cljs.core.nth.call(null,vec__92147,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__92147,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__28569__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__28569__auto__)){
return or__28569__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__92150_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__92151_SHARP_);
...
var args__29809__auto__ = [];
var len__29802__auto___92158 = arguments.length;
var i__29803__auto___92159 = (0);
while(true){
if((i__29803__auto___92159 < len__29802__auto___92158)){
args__29809__auto__.push((arguments[i__29803__auto___92159]));

var G__92160 = (i__29803__auto___92159 + (1));
i__29803__auto___92159 = G__92160;
continue;
} else {
}
break;
...
var argseq__29810__auto__ = ((((1) < args__29809__auto__.length))?(new cljs.core.IndexedSeq(args__29809__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29810__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__92154){
var vec__92155 = p__92154;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__92155,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq92152){
var G__92153 = cljs.core.first.call(null,seq92152);
var seq92152__$1 = cljs.core.next.call(null,seq92152);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__92153,seq92152__$1);
});
...
var G__92161 = arg;
var G__92161__$1 = (((G__92161 instanceof cljs.core.Keyword))?G__92161.fqn:null);
switch (G__92161__$1) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__28569__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__28569__auto__)){
return or__28569__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__28557__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__28569__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__28569__auto__)){
return or__28569__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__92163__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__92163__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__92163__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__92163__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__92164 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__92164,(0),null);
var fn_name = cljs.core.nth.call(null,vec__92164,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__92164,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__92164,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__92164,(4),null);
var arity = cljs.core.nth.call(null,vec__92164,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__28557__auto__ = protocol_ns;
if(cljs.core.truth_(and__28557__auto__)){
return cljs.core.not.call(null,(function (){var and__28557__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__28569__auto__ = protocol_part;
if(cljs.core.truth_(or__28569__auto__)){
return or__28569__auto__;
} else {
return fn_part;
...
var o__38323__auto__ = f;
return goog.object.get(o__38323__auto__,"getBasis").call(o__38323__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__28557__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__28557__auto__)){
...
}catch (e92168){var e__38348__auto__ = e92168;
...
var G__92169 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__92170 = cljs.core.rest.call(null,path);
obj = G__92169;
path = G__92170;
continue;
} else {
...
var partition_bits = (function (){var or__28569__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__28569__auto__)){
return or__28569__auto__;
} else {
return (0);
...
return (function (accum,p__92171){
var vec__92172 = p__92171;
var bit = cljs.core.nth.call(null,vec__92172,(0),null);
var protocol = cljs.core.nth.call(null,vec__92172,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__92175){
var vec__92176 = p__92175;
var ns = cljs.core.nth.call(null,vec__92176,(0),null);
var name = cljs.core.nth.call(null,vec__92176,(1),null);
var selector = cljs.core.nth.call(null,vec__92176,(2),null);
...
return (function (p__92180){
var vec__92181 = p__92180;
var munged_name = cljs.core.nth.call(null,vec__92181,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__92181,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__92181,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__92179_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__92179_SHARP_));
});})(name,sorted_matches,vec__92181,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1500526712845