...
try{var o__37719__auto___38584 = t;
goog.object.get(o__37719__auto___38584,"cljs$lang$ctorPrWriter").call(o__37719__auto___38584,t,writer);
}catch (e38583){var __38585 = e38583;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__38587 = num_code;
switch (G__38587) {
case (1):
return (185);
...
}catch (e38593){var e__37744__auto__ = e38593;
return false;
}})())){
...
var vec__38594 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__38594,(0),null);
...
var len__27054__auto___38603 = arguments.length;
var i__27055__auto___38604 = (0);
while(true){
if((i__27055__auto___38604 < len__27054__auto___38603)){
args__27061__auto__.push((arguments[i__27055__auto___38604]));

var G__38605 = (i__27055__auto___38604 + (1));
i__27055__auto___38604 = G__38605;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__38599){
var vec__38600 = p__38599;
var ns_detector = cljs.core.nth.call(null,vec__38600,(0),null);
...
var G__38606 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__38607 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__38606;
remaining_tokens = G__38607;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq38597){
var G__38598 = cljs.core.first.call(null,seq38597);
var seq38597__$1 = cljs.core.next.call(null,seq38597);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__38598,seq38597__$1);
});
...
var vec__38615 = cljs.core.split_with.call(null,(function (p1__38611_SHARP_){
return cljs.core.not_EQ_.call(null,p1__38611_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__38615,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__38615,(1),null);
...
var vec__38621 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__38621,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__38621,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__38624 = cljs.core.rest.call(null,remaining_tokens);
var G__38625 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__38624;
name_tokens = G__38625;
continue;
} else {
...
var args38626 = [];
var len__27054__auto___38638 = arguments.length;
var i__27055__auto___38639 = (0);
while(true){
if((i__27055__auto___38639 < len__27054__auto___38638)){
args38626.push((arguments[i__27055__auto___38639]));

var G__38640 = (i__27055__auto___38639 + (1));
i__27055__auto___38639 = G__38640;
continue;
} else {
}
break;
...
var vec__38629 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__38629,(0),null);
var arity = cljs.core.nth.call(null,vec__38629,(1),null);
var vec__38632 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__38632,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__38632,(1),null);
var vec__38635 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__38635,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__38635,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__38635,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__38635,(3),null);
...
var args38642 = [];
var len__27054__auto___38648 = arguments.length;
var i__27055__auto___38649 = (0);
while(true){
if((i__27055__auto___38649 < len__27054__auto___38648)){
args38642.push((arguments[i__27055__auto___38649]));

var G__38650 = (i__27055__auto___38649 + (1));
i__27055__auto___38649 = G__38650;
continue;
} else {
}
break;
...
var vec__38645 = result;
var munged_ns = cljs.core.nth.call(null,vec__38645,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__38645,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__38645,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__38645,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__38645,(4),null);
var arity = cljs.core.nth.call(null,vec__38645,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__38658 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__38658,(0),null);
var args = cljs.core.nth.call(null,vec__38658,(1),null);
var vec__38661 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__38661,(0),null);
var name = cljs.core.nth.call(null,vec__38661,(1),null);
...
var G__38664 = (arity + (1));
var G__38665 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__38666){
var vec__38670 = p__38666;
var arity = cljs.core.nth.call(null,vec__38670,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__38670,(1),null);
...
return cljs.core.get.call(null,arities,p1__38673_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__38674_SHARP_);
...
var args__27061__auto__ = [];
var len__27054__auto___38681 = arguments.length;
var i__27055__auto___38682 = (0);
while(true){
if((i__27055__auto___38682 < len__27054__auto___38681)){
args__27061__auto__.push((arguments[i__27055__auto___38682]));

var G__38683 = (i__27055__auto___38682 + (1));
i__27055__auto___38682 = G__38683;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__38677){
var vec__38678 = p__38677;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__38678,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq38675){
var G__38676 = cljs.core.first.call(null,seq38675);
var seq38675__$1 = cljs.core.next.call(null,seq38675);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__38676,seq38675__$1);
});
...
var G__38685 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__38685) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__38692__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__38692__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__38692__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__38692__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__38693 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__38693,(0),null);
var fn_name = cljs.core.nth.call(null,vec__38693,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__38693,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__38693,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__38693,(4),null);
var arity = cljs.core.nth.call(null,vec__38693,(5),null);
...
}catch (e38698){var e__37744__auto__ = e38698;
...
var G__38699 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__38700 = cljs.core.rest.call(null,path);
obj = G__38699;
path = G__38700;
continue;
} else {
...
return (function (accum,p__38705){
var vec__38706 = p__38705;
var bit = cljs.core.nth.call(null,vec__38706,(0),null);
var protocol = cljs.core.nth.call(null,vec__38706,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__38709){
var vec__38713 = p__38709;
var ns = cljs.core.nth.call(null,vec__38713,(0),null);
var name = cljs.core.nth.call(null,vec__38713,(1),null);
var selector = cljs.core.nth.call(null,vec__38713,(2),null);
...
return (function (p__38721){
var vec__38722 = p__38721;
var munged_name = cljs.core.nth.call(null,vec__38722,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__38722,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__38722,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__38716_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__38716_SHARP_));
});})(name,sorted_matches,vec__38722,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1499543392046