...
try{var o__38323__auto___38493 = t;
goog.object.get(o__38323__auto___38493,"cljs$lang$ctorPrWriter").call(o__38323__auto___38493,t,writer);
}catch (e38492){var __38494 = e38492;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__38495 = num_code;
switch (G__38495) {
case (1):
return (185);
...
}catch (e38497){var e__38348__auto__ = e38497;
return false;
}})())){
...
var vec__38498 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__38498,(0),null);
...
var len__29802__auto___38507 = arguments.length;
var i__29803__auto___38508 = (0);
while(true){
if((i__29803__auto___38508 < len__29802__auto___38507)){
args__29809__auto__.push((arguments[i__29803__auto___38508]));

var G__38509 = (i__29803__auto___38508 + (1));
i__29803__auto___38508 = G__38509;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__38503){
var vec__38504 = p__38503;
var ns_detector = cljs.core.nth.call(null,vec__38504,(0),null);
...
var G__38510 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__38511 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__38510;
remaining_tokens = G__38511;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq38501){
var G__38502 = cljs.core.first.call(null,seq38501);
var seq38501__$1 = cljs.core.next.call(null,seq38501);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__38502,seq38501__$1);
});
...
var vec__38515 = cljs.core.split_with.call(null,(function (p1__38514_SHARP_){
return cljs.core.not_EQ_.call(null,p1__38514_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__38515,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__38515,(1),null);
...
var vec__38518 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__38518,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__38518,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__38521 = cljs.core.rest.call(null,remaining_tokens);
var G__38522 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__38521;
name_tokens = G__38522;
continue;
} else {
...
var vec__38525 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__38525,(0),null);
var arity = cljs.core.nth.call(null,vec__38525,(1),null);
var vec__38528 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__38528,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__38528,(1),null);
var vec__38531 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__38531,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__38531,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__38531,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__38531,(3),null);
...
var vec__38537 = result;
var munged_ns = cljs.core.nth.call(null,vec__38537,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__38537,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__38537,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__38537,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__38537,(4),null);
var arity = cljs.core.nth.call(null,vec__38537,(5),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var vec__38541 = temp__5276__auto__;
var munged_name = cljs.core.nth.call(null,vec__38541,(0),null);
var args = cljs.core.nth.call(null,vec__38541,(1),null);
var vec__38544 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__38544,(0),null);
var name = cljs.core.nth.call(null,vec__38544,(1),null);
...
var G__38547 = (arity + (1));
var G__38548 = (function (){var temp__5276__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5276__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__38549){
var vec__38550 = p__38549;
var arity = cljs.core.nth.call(null,vec__38550,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__38550,(1),null);
...
return cljs.core.get.call(null,arities,p1__38553_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__38554_SHARP_);
...
var args__29809__auto__ = [];
var len__29802__auto___38561 = arguments.length;
var i__29803__auto___38562 = (0);
while(true){
if((i__29803__auto___38562 < len__29802__auto___38561)){
args__29809__auto__.push((arguments[i__29803__auto___38562]));

var G__38563 = (i__29803__auto___38562 + (1));
i__29803__auto___38562 = G__38563;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__38557){
var vec__38558 = p__38557;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__38558,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq38555){
var G__38556 = cljs.core.first.call(null,seq38555);
var seq38555__$1 = cljs.core.next.call(null,seq38555);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__38556,seq38555__$1);
});
...
var map__38566 = options;
var map__38566__$1 = ((((!((map__38566 == null)))?((((map__38566.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38566.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38566):map__38566);
var include_ns_QMARK_ = cljs.core.get.call(null,map__38566__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__38566__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__38566__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__38566__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__38567 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__38567,(0),null);
var fn_name = cljs.core.nth.call(null,vec__38567,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__38567,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__38567,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__38567,(4),null);
var arity = cljs.core.nth.call(null,vec__38567,(5),null);
...
}catch (e38572){var e__38348__auto__ = e38572;
...
var G__38573 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__38574 = cljs.core.rest.call(null,path);
obj = G__38573;
path = G__38574;
continue;
} else {
...
return (function (accum,p__38575){
var vec__38576 = p__38575;
var bit = cljs.core.nth.call(null,vec__38576,(0),null);
var protocol = cljs.core.nth.call(null,vec__38576,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__38579){
var vec__38580 = p__38579;
var ns = cljs.core.nth.call(null,vec__38580,(0),null);
var name = cljs.core.nth.call(null,vec__38580,(1),null);
var selector = cljs.core.nth.call(null,vec__38580,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__38585,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__38585,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__38585,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__38583_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__38583_SHARP_));
});})(name,sorted_matches,vec__38585,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1500449676670