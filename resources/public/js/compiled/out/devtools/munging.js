...
var temp__4657__auto____$1 = goog.object.get(o__37732__auto__,"core");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__37731__auto__ = temp__4657__auto____$1;
return goog.object.get(o__37731__auto__,"js_reserved_QMARK_");
} else {
return null;
}
} else {
...
try{var o__37719__auto__ = f;
return goog.object.get(o__37719__auto__,"toString").call(o__37719__auto__);
}catch (e61841){var _ = e61841;
return "";
}});
...
try{var o__37719__auto___61844 = t;
goog.object.get(o__37719__auto___61844,"cljs$lang$ctorPrWriter").call(o__37719__auto___61844,t,writer);
}catch (e61843){var __61845 = e61843;
}
...
var char_code = (function (){var o__37719__auto__ = (new String(char$));
return goog.object.get(o__37719__auto__,"charCodeAt").call(o__37719__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__37719__auto__ = String;
return goog.object.get(o__37719__auto__,"fromCharCode").call(o__37719__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__61847 = num_code;
switch (G__61847) {
case (1):
return (185);
...
var o__37719__auto__ = String;
return goog.object.get(o__37719__auto__,"fromCharCode").call(o__37719__auto__,superscript_code);
});
/**
...
}catch (e61853){var e__37744__auto__ = e61853;
return false;
}})())){
...
var vec__61854 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__61854,(0),null);
...
if(cljs.core.truth_(temp__4657__auto__)){
var o__37732__auto__ = temp__4657__auto__;
var temp__4657__auto____$1 = goog.object.get(o__37732__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__37731__auto__ = temp__4657__auto____$1;
return goog.object.get(o__37731__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__27054__auto___61863 = arguments.length;
var i__27055__auto___61864 = (0);
while(true){
if((i__27055__auto___61864 < len__27054__auto___61863)){
args__27061__auto__.push((arguments[i__27055__auto___61864]));

var G__61865 = (i__27055__auto___61864 + (1));
i__27055__auto___61864 = G__61865;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__61859){
var vec__61860 = p__61859;
var ns_detector = cljs.core.nth.call(null,vec__61860,(0),null);
...
var G__61866 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__61867 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__61866;
remaining_tokens = G__61867;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq61857){
var G__61858 = cljs.core.first.call(null,seq61857);
var seq61857__$1 = cljs.core.next.call(null,seq61857);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__61858,seq61857__$1);
});
...
var vec__61875 = cljs.core.split_with.call(null,(function (p1__61871_SHARP_){
return cljs.core.not_EQ_.call(null,p1__61871_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__61875,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__61875,(1),null);
...
var vec__61881 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__61881,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__61881,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__61884 = cljs.core.rest.call(null,remaining_tokens);
var G__61885 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__61884;
name_tokens = G__61885;
continue;
} else {
...
var args61886 = [];
var len__27054__auto___61898 = arguments.length;
var i__27055__auto___61899 = (0);
while(true){
if((i__27055__auto___61899 < len__27054__auto___61898)){
args61886.push((arguments[i__27055__auto___61899]));

var G__61900 = (i__27055__auto___61899 + (1));
i__27055__auto___61899 = G__61900;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args61886.length)].join('')));
...
var vec__61889 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__61889,(0),null);
var arity = cljs.core.nth.call(null,vec__61889,(1),null);
var vec__61892 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__61892,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__61892,(1),null);
var vec__61895 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__61895,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__61895,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__61895,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__61895,(3),null);
...
var args61902 = [];
var len__27054__auto___61908 = arguments.length;
var i__27055__auto___61909 = (0);
while(true){
if((i__27055__auto___61909 < len__27054__auto___61908)){
args61902.push((arguments[i__27055__auto___61909]));

var G__61910 = (i__27055__auto___61909 + (1));
i__27055__auto___61909 = G__61910;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args61902.length)].join('')));
...
var vec__61905 = result;
var munged_ns = cljs.core.nth.call(null,vec__61905,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__61905,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__61905,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__61905,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__61905,(4),null);
var arity = cljs.core.nth.call(null,vec__61905,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__61918 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__61918,(0),null);
var args = cljs.core.nth.call(null,vec__61918,(1),null);
var vec__61921 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__61921,(0),null);
var name = cljs.core.nth.call(null,vec__61921,(1),null);
...
var G__61924 = (arity + (1));
var G__61925 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__61926){
var vec__61930 = p__61926;
var arity = cljs.core.nth.call(null,vec__61930,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__61930,(1),null);
...
return cljs.core.get.call(null,arities,p1__61933_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__61934_SHARP_);
...
var args__27061__auto__ = [];
var len__27054__auto___61941 = arguments.length;
var i__27055__auto___61942 = (0);
while(true){
if((i__27055__auto___61942 < len__27054__auto___61941)){
args__27061__auto__.push((arguments[i__27055__auto___61942]));

var G__61943 = (i__27055__auto___61942 + (1));
i__27055__auto___61942 = G__61943;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__61937){
var vec__61938 = p__61937;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__61938,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq61935){
var G__61936 = cljs.core.first.call(null,seq61935);
var seq61935__$1 = cljs.core.next.call(null,seq61935);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__61936,seq61935__$1);
});
...
var G__61945 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__61945) {
...
var map__61952 = options;
var map__61952__$1 = ((((!((map__61952 == null)))?((((map__61952.cljs$lang$protocol_mask$partition0$ & (64))) || (map__61952.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__61952):map__61952);
var include_ns_QMARK_ = cljs.core.get.call(null,map__61952__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__61952__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__61952__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__61952__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__61953 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__61953,(0),null);
var fn_name = cljs.core.nth.call(null,vec__61953,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__61953,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__61953,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__61953,(4),null);
var arity = cljs.core.nth.call(null,vec__61953,(5),null);
...
var o__37719__auto__ = f;
return goog.object.get(o__37719__auto__,"getBasis").call(o__37719__auto__);
});
/**
...
}catch (e61958){var e__37744__auto__ = e61958;
...
var G__61959 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__61960 = cljs.core.rest.call(null,path);
obj = G__61959;
path = G__61960;
continue;
} else {
...
return (function (accum,p__61965){
var vec__61966 = p__61965;
var bit = cljs.core.nth.call(null,vec__61966,(0),null);
var protocol = cljs.core.nth.call(null,vec__61966,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__61969){
var vec__61973 = p__61969;
var ns = cljs.core.nth.call(null,vec__61973,(0),null);
var name = cljs.core.nth.call(null,vec__61973,(1),null);
var selector = cljs.core.nth.call(null,vec__61973,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__61982,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__61982,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__61982,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__61976_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__61976_SHARP_));
});})(name,sorted_matches,vec__61982,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1499548780676