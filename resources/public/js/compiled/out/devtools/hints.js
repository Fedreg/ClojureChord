...
var map__36651 = top_item;
var map__36651__$1 = ((((!((map__36651 == null)))?((((map__36651.cljs$lang$protocol_mask$partition0$ & (64))) || (map__36651.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__36651):map__36651);
var file = cljs.core.get.call(null,map__36651__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__36651__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__36651__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e36650){var _e = e36650;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___36653 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___36653)){
var seen_errors_36654 = temp__4655__auto___36653;
if(cljs.core.truth_(seen_errors_36654.has(self))){
} else {
seen_errors_36654.add(self);

var temp__4657__auto___36655 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___36655)){
var sense_36656 = temp__4657__auto___36655;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_36656)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1499366869232