...
var map__40299 = top_item;
var map__40299__$1 = ((((!((map__40299 == null)))?((((map__40299.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40299.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40299):map__40299);
var file = cljs.core.get.call(null,map__40299__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__40299__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__40299__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e40298){var _e = e40298;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5276__auto___40301 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5276__auto___40301)){
var seen_errors_40302 = temp__5276__auto___40301;
if(cljs.core.truth_(seen_errors_40302.has(self))){
} else {
seen_errors_40302.add(self);

var temp__5278__auto___40303 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5278__auto___40303)){
var sense_40304 = temp__5278__auto___40303;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),cljs.core.str.cljs$core$IFn$_invoke$arity$1(", a sanity hint:\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_40304)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1500435988590