...
var map__40514 = top_item;
var map__40514__$1 = ((((!((map__40514 == null)))?((((map__40514.cljs$lang$protocol_mask$partition0$ & (64))) || (map__40514.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40514):map__40514);
var file = cljs.core.get.call(null,map__40514__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__40514__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__40514__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e40513){var _e = e40513;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___40516 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___40516)){
var seen_errors_40517 = temp__4655__auto___40516;
if(cljs.core.truth_(seen_errors_40517.has(self))){
} else {
seen_errors_40517.add(self);

var temp__4657__auto___40518 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___40518)){
var sense_40519 = temp__4657__auto___40518;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_40519)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1499270890405