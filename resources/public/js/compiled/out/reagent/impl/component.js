...
if((i < len)){
var k = (ks[i]);
var G__27596 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__27597 = (i + (1));
m = G__27596;
i = G__27597;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__27601 = c;
var G__27601__$1 = (((G__27601 == null))?null:G__27601.prototype);
if((G__27601__$1 == null)){
return null;
} else {
return (G__27601__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__27605 = c;
var G__27605__$1 = (((G__27605 == null))?null:G__27605.prototype);
if((G__27605__$1 == null)){
return null;
} else {
return (G__27605__$1["render"]);
}
})()));
});
...
return (function() { 
var G__27609__delegate = function (args){
...
while (G__27610__i < G__27610__a.length) {G__27610__a[G__27610__i] = arguments[G__27610__i + 0]; ++G__27610__i;}
  args = new cljs.core.IndexedSeq(G__27610__a,0);
} 
return G__27609__delegate.call(this,args);};
G__27609.cljs$lang$maxFixedArity = 0;
G__27609.cljs$lang$applyTo = (function (arglist__27611){
var args = cljs.core.seq(arglist__27611);
return G__27609__delegate(args);
});
...
var _STAR_current_component_STAR_27614 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_27614;
}});
...
var G__27618 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__27618) {
...
var c = this;
var G__27620_27622 = (c["cljsRatom"]);
if((G__27620_27622 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__27620_27622);
}
...
if(((1) === cljs.core.count.call(null,renders_27625))){
} else {
...
if(cljs.core.ifn_QMARK_.call(null,render_fun_27626)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun_27626))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}
...
var name__$1 = (function (){var G__27624 = name;
switch (G__27624) {
case "":
...
var G__27629 = o;
(G__27629[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__27635 = (function (){var or__25979__auto__ = (function (){var G__27637 = c;
if((G__27637 == null)){
return null;
} else {
return (G__27637["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__25979__auto__)){
return or__25979__auto__;
...
return (G__27635["_currentElement"]);
}
})();
var name = (function (){var G__27638 = elem;
var G__27638__$1 = (((G__27638 == null))?null:(G__27638["type"]));
if((G__27638__$1 == null)){
return null;
} else {
return (G__27638__$1["displayName"]);
}
})();
var path = (function (){var G__27639 = elem;
var G__27639__$1 = (((G__27639 == null))?null:(G__27639["_owner"]));
var G__27639__$2 = (((G__27639__$1 == null))?null:reagent$impl$component$component_path.call(null,G__27639__$1));
if((G__27639__$2 == null)){
return null;
} else {
return [cljs.core.str(G__27639__$2),cljs.core.str(" > ")].join('');
}
})();
...
return reagent.impl.util.fun_name.call(null,G__27641__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1499270862809