...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__29226__auto__,writer__29227__auto__,opt__29228__auto__){
return cljs.core._write.call(null,writer__29227__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__87378 = o;
(G__87378[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__87379__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__87379 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__87380__i = 0, G__87380__a = new Array(arguments.length -  0);
while (G__87380__i < G__87380__a.length) {G__87380__a[G__87380__i] = arguments[G__87380__i + 0]; ++G__87380__i;}
  args = new cljs.core.IndexedSeq(G__87380__a,0,null);
} 
return G__87379__delegate.call(this,args);};
G__87379.cljs$lang$maxFixedArity = 0;
G__87379.cljs$lang$applyTo = (function (arglist__87381){
var args = cljs.core.seq(arglist__87381);
return G__87379__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__28557__auto__ = !((jsprops == null));
if(and__28557__auto__){
var and__28557__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__87384 = jsprops;
(G__87384["defaultValue"] = value);

(G__87384["onChange"] = ((function (G__87384,v,value,on_change){
return (function (p1__87383_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__87383_SHARP_);
});})(G__87384,v,value,on_change))
);
...
var vec__87387 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__87387,(0),null);
var id = cljs.core.nth.call(null,vec__87387,(1),null);
var class$ = cljs.core.nth.call(null,vec__87387,(2),null);
...
var jsprops = ({"argv": v});
var temp__5282__auto___87391 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5282__auto___87391 == null)){
} else {
var key_87392 = temp__5282__auto___87391;
(jsprops["key"] = key_87392);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__87393 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__87393["name"] = c);
...
var len__29802__auto___87398 = arguments.length;
var i__29803__auto___87399 = (0);
while(true){
if((i__29803__auto___87399 < len__29802__auto___87398)){
args__29809__auto__.push((arguments[i__29803__auto___87399]));

var G__87400 = (i__29803__auto___87399 + (1));
i__29803__auto___87399 = G__87400;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29810__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq87396){
var G__87397 = cljs.core.first.call(null,seq87396);
var seq87396__$1 = cljs.core.next.call(null,seq87396);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__87397,seq87396__$1);
});
...
break;
default:
var G__87403 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__87403;
continue;
...
var n__29591__auto___87405 = a.length;
var i_87406 = (0);
while(true){
if((i_87406 < n__29591__auto___87405)){
(a[i_87406] = reagent.impl.template.as_element.call(null,(a[i_87406])));

var G__87407 = (i_87406 + (1));
i_87406 = G__87407;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__29591__auto___87408 = a.length;
var i_87409 = (0);
while(true){
if((i_87409 < n__29591__auto___87408)){
var val_87410 = (a[i_87409]);
if((cljs.core.vector_QMARK_.call(null,val_87410)) && ((reagent.impl.template.key_from_vec.call(null,val_87410) == null))){
(o["no-key"] = true);
} else {
}

(a[i_87409] = reagent.impl.template.as_element.call(null,val_87410));

var G__87411 = (i_87409 + (1));
i_87409 = G__87411;
continue;
} else {
}
...
var ctx = ({});
var vec__87412 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__87412,(0),null);
var derefed = cljs.core.nth.call(null,vec__87412,(1),null);
...
var G__87415 = (cljs.core.count.call(null,argv) - first_child);
switch (G__87415) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__87415){
...
//# sourceMappingURL=template.js.map?rel=1500526516856