...
tabber.songViewer._BANG_beat = reagent.core.cursor.call(null,tabber.state.app_state,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"beat","beat",-817854366)], null));
tabber.songViewer._BANG_index = reagent.core.cursor.call(null,tabber.state.app_state,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"index","index",-1531685915)], null));
tabber.songViewer._BANG_song = reagent.core.cursor.call(null,tabber.state.app_state,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"song","song",-62793121)], null));
tabber.songViewer._BANG_tempo = reagent.core.cursor.call(null,tabber.state.app_state,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tempo","tempo",-1555208453)], null));
tabber.songViewer._BANG_chords = reagent.core.cursor.call(null,tabber.state.app_state,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"chords","chords",234981817)], null));
tabber.songViewer._BANG_rawSong = reagent.core.cursor.call(null,tabber.state.app_state,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"rawSong","rawSong",692155150)], null));
...
tabber.songViewer.FormatSong = (function tabber$songViewer$FormatSong(){
var song = cljs.core.deref.call(null,tabber.songViewer._BANG_rawSong);
var song__$1 = clojure.string.split.call(null,song,/ /);
var song__$2 = cljs.core.filter.call(null,((function (song,song__$1){
return (function (p1__74851_SHARP_){
return !(cljs.core.empty_QMARK_.call(null,p1__74851_SHARP_));
});})(song,song__$1))
,song__$1);
var song__$3 = cljs.core.map.call(null,((function (song,song__$1,song__$2){
return (function (p1__74852_SHARP_){
return clojure.string.split.call(null,p1__74852_SHARP_,/\//);
});})(song,song__$1,song__$2))
,song__$2);
var song__$4 = cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["X","X","4"], null),song__$3);
return cljs.core.reset_BANG_.call(null,tabber.state.app_state,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"song","song",-62793121)], null),song__$4);
});
tabber.songViewer.Tempo = (function tabber$songViewer$Tempo(){
return ((1000) * ((60) / cljs.core.deref.call(null,tabber.songViewer._BANG_tempo)));
});
tabber.songViewer.StartBeatCounter = (function tabber$songViewer$StartBeatCounter(){
var numberOfBeats = (parseInt(cljs.core.last.call(null,cljs.core.nth.call(null,cljs.core.deref.call(null,tabber.songViewer._BANG_song),cljs.core.deref.call(null,tabber.songViewer._BANG_index)))) + (1));
if((cljs.core.deref.call(null,tabber.songViewer._BANG_beat) < numberOfBeats)){
...
cljs.core.deref.call(null,tabber.songViewer._BANG_beat);

var range = cljs.core.range.call(null,(1),(parseInt(cljs.core.last.call(null,cljs.core.nth.call(null,cljs.core.deref.call(null,tabber.songViewer._BANG_song),cljs.core.deref.call(null,tabber.songViewer._BANG_index)))) + (1)));
...
return (function (p1__74853_SHARP_){
return (cljs.core._EQ_.call(null,key,cljs.core.first.call(null,p1__74853_SHARP_))) && (cljs.core._EQ_.call(null,quality,cljs.core.second.call(null,p1__74853_SHARP_)));
});})(key,quality))
,collection);
});
tabber.songViewer.ChordPreviewList = (function tabber$songViewer$ChordPreviewList(){
var songChords = cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,cljs.core.distinct.call(null,cljs.core.map.call(null,(function (p1__74854_SHARP_){
return cljs.core.take.call(null,(2),p1__74854_SHARP_);
}),cljs.core.drop.call(null,(2),cljs.core.deref.call(null,tabber.songViewer._BANG_song)))));
...
return (function (p1__74855_SHARP_){
return cljs.core.contains_QMARK_.call(null,songChords,cljs.core.take.call(null,(2),p1__74855_SHARP_));
});})(songChords))
,cljs.core.deref.call(null,tabber.songViewer._BANG_chords)))], null);
});
tabber.songViewer.CurrentChord = (function tabber$songViewer$CurrentChord(){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),tabber.songViewer.CurrentChordStyle], null),((cljs.core._EQ_.call(null,(1),cljs.core.deref.call(null,tabber.songViewer._BANG_index)))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),tabber.songViewer.GetReadyStyle.call(null)], null),"Get Ready!"], null):cljs.core.map.call(null,tabber.chordChart.ChordChart,tabber.songViewer.SongChordFilter.call(null,cljs.core.deref.call(null,tabber.songViewer._BANG_chords),cljs.core.deref.call(null,tabber.songViewer._BANG_song),cljs.core.deref.call(null,tabber.songViewer._BANG_index))))], null);
});
tabber.songViewer.OnDeckChord = (function tabber$songViewer$OnDeckChord(num,upper){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),tabber.songViewer.OnDeckChordStyle.call(null,upper)], null),((((num + cljs.core.deref.call(null,tabber.songViewer._BANG_index)) < cljs.core.count.call(null,cljs.core.deref.call(null,tabber.songViewer._BANG_song))))?cljs.core.map.call(null,tabber.chordChart.ChordChart,tabber.songViewer.SongChordFilter.call(null,cljs.core.deref.call(null,tabber.songViewer._BANG_chords),cljs.core.deref.call(null,tabber.songViewer._BANG_song),(num + cljs.core.deref.call(null,tabber.songViewer._BANG_index)))):"")], null);
});
tabber.songViewer.SongTitle = (function tabber$songViewer$SongTitle(){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),tabber.songViewer.SongTitleStyle.call(null)], null),cljs.core.nth.call(null,cljs.core.deref.call(null,tabber.songViewer._BANG_song),(0))], null);
});
...
//# sourceMappingURL=songViewer.js.map?rel=1499925798907